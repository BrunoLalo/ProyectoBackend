const errorsDictionary = {
    ...
    FEW_PARAMETERS: {
      code: 400,
      message: "Faltan parámetros obligatorios o están vacíos",
    },

    INVALID_MONGOID_FORMAT: {
      code: 400,
      message: "El ID no contiene un formato válido de MongoDB",
    },

    INVALID_PARAMETER: {
      code: 400,
      message: "El parámetro ingresado no es válido",
    },
